...
For lung samples, topics 1,6,8 has different average proportions across batches, and some other topics can have very large variations within the same batch.

For spleen samples, topic 7 has different mean proportions across batches. 
...
For lungs, we see topic 1 and 6 have higher mean proportion mainly due to Lung_COB-6 sample from batch 4. Topic 8 has higher mean proportion in batch 5 (contributed by COB-11).

For spleens, high mean proportion of topic 7 can be attributed to spleen_SMO-10 sample from batch 3.
