...
lung_B$ambigous[findOverlaps(lung_B, GRanges(ambigousPeaks))@from] <- "lung-ambiguous"
...
```{r}
# all lung peaks
lung_T$ambigous <- "lung-ony"
lung_T$ambigous[findOverlaps(lung_T, GRanges(ambigousPeaks))@from] <- "lung-ambiguous"
#z_spleen <- mergeByOverlaps(spleen_B, f_hg38_gr)
