...
3. Compute average levels for each overlapping peak that contain fine-mapped variants 
  * within tissue 
  * across tissues (for cross-tissue comparison)
