...
DT::datatable(
  enrich_out %>% 
    ...
    mutate(p=format(pValue, scientific=TRUE, digits=2),
           enrichment=format(enrichmentRatio, digits=2)) %>%
    select(c(k, description, enrichment, p)),
   caption=db[3]
  )
```
...
Which cell types show clear separation from visual inspection?
* k7: NK, Memory B
* k8: Treg, CD4, Th17
* k9: NK, other, Treg, CD8T, Th17
